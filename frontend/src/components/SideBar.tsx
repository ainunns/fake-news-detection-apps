...
export const Sidebar = ({ isResponsive, ...props }: SideBarProps) => {
    ...
    // Using useAutoAnimate without generics, and later casting to HTMLDivElement
    ...
    useEffect(() => {
        setMounted(true); // Set the component as mounted after it has rendered
    }, []);
            ...
            <AccountModal title="Your account">
                <Stack
                    ...
                    divider={
                        <Divider
                            orientation={
                                !isResponsive ? "vertical" : "horizontal"
                            }
                        />
                    }
                >
